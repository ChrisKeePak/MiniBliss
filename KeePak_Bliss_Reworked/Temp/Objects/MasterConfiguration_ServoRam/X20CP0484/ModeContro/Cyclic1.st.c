...
#include "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_Reworked/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/ModeContro/Cyclic1st.h"
#line 1 "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_Reworked/Logical/ModeControl/ModeControl_ST/Cyclic1.nodebug"
#line 2 "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_Reworked/Logical/ModeControl/ModeControl_ST/Cyclic1.st"
void _CYCLIC __BUR__ENTRY_CYCLIC_FUNCT__(void){{



(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[0].DelayDistance[0]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[0].DelayDistance[0]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[0].DelayDistance[1]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[0].DelayDistance[1]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[0].DelayDistance[2]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[0].DelayDistance[2]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[0].DelayDistance[3]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[0].DelayDistance[3]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[1].DelayDistance[0]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[1].DelayDistance[0]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[1].DelayDistance[1]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[1].DelayDistance[1]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[1].DelayDistance[2]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[1].DelayDistance[2]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[1].DelayDistance[3]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[1].DelayDistance[3]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[2].DelayDistance[0]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[2].DelayDistance[0]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[2].DelayDistance[1]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[2].DelayDistance[1]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[2].DelayDistance[2]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[2].DelayDistance[2]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[2].DelayDistance[3]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[2].DelayDistance[3]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[3].DelayDistance[0]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[3].DelayDistance[0]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[3].DelayDistance[1]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[3].DelayDistance[1]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[3].DelayDistance[2]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[3].DelayDistance[2]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[3].DelayDistance[3]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[3].DelayDistance[3]*2.53999996185302734375E+01));

(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[0].GlueOnDistance[0]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[0].GlueOnDistance[0]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[0].GlueOnDistance[1]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[0].GlueOnDistance[1]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[0].GlueOnDistance[2]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[0].GlueOnDistance[2]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[0].GlueOnDistance[3]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[0].GlueOnDistance[3]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[1].GlueOnDistance[0]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[1].GlueOnDistance[0]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[1].GlueOnDistance[1]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[1].GlueOnDistance[1]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[1].GlueOnDistance[2]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[1].GlueOnDistance[2]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[1].GlueOnDistance[3]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[1].GlueOnDistance[3]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[2].GlueOnDistance[0]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[2].GlueOnDistance[0]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[2].GlueOnDistance[1]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[2].GlueOnDistance[1]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[2].GlueOnDistance[2]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[2].GlueOnDistance[2]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[2].GlueOnDistance[3]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[2].GlueOnDistance[3]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[3].GlueOnDistance[0]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[3].GlueOnDistance[0]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[3].GlueOnDistance[1]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[3].GlueOnDistance[1]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[3].GlueOnDistance[2]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[3].GlueOnDistance[2]*2.53999996185302734375E+01));
(gAdhesiveCtrlInterface.Parameters.AdhesivePatterns[3].GlueOnDistance[3]=(gAdhesiveCtrlInterface.Parameters.AdhesiveHMIPatterns[3].GlueOnDistance[3]*2.53999996185302734375E+01));
...
if((gServoFeedInterface.Status.Error|gBodyHopperInterface.Status.Error|gLeftHopperInterface.Status.Error|gRightHopperInterface.Status.Error|gServoRamInterface.Status.Error|(gIO.DIs.SafetyOK^1)|gHMI.Commands.SelectJogMode|gHighSeverityAlarmActive|BodyCheckError)){
...
if((gAdhesiveCtrlInterface.Status.AlarmActive|gServoFeedInterface.Status.Error|gBodyHopperInterface.Status.Error|gLeftHopperInterface.Status.Error|gRightHopperInterface.Status.Error|gServoRamInterface.Status.Error|gLowSeverityAlarmActive|gHighSeverityAlarmActive|gServoPnPInterface.Status.Error)){
(gHMI.Commands.RequestVFDRun=0);
}



(MoveVelocityRequest=(gHMI.Commands.SelectAutoMode&gHMI.Commands.RequestVFDRun));
...
(gHMI.Commands.StartBodyHopper=gHMI.Commands.RequestVFDRun);
(gHMI.Commands.StartLeftHopper=gHMI.Commands.RequestVFDRun);
(gHMI.Commands.StartRightHopper=gHMI.Commands.RequestVFDRun);
(gHMI.Commands.StartServoFeed=(gHMI.Commands.RequestVFDRun&(StopFeedServo^1)));
(gHMI.Commands.CycleServoRam=gHMI.Commands.RequestVFDRun);
(gHMI.Commands.CycleServoPnP=gHMI.Commands.RequestVFDRun);


(gIO.DOs.OutConveyorOn_1=(gHMI.Commands.RequestVFDRun|(((signed long)(signed long)(char)gCyclesToFinish>(signed long)(signed long)(char)0))));
(gIO.DOs.OutConveyorOn_2=(gHMI.Commands.RequestVFDRun|(((signed long)(signed long)(char)gCyclesToFinish>(signed long)(signed long)(char)0))));
(gIO.DOs.OutConveyorOn_3=(gHMI.Commands.RequestVFDRun|(((signed long)(signed long)(char)gCyclesToFinish>(signed long)(signed long)(char)0))));
...
(BodyHopperLowTMR.IN=gIO.DIs.BodyHopperLow);
(BodyHopperLowTMR.PT=gHMI.Parameters.LowBodyHopperTime);
TON(&BodyHopperLowTMR);
if(BodyHopperLowTMR.Q){
(BodyHopperLowAlarm=1);
}
(LeftHopperLowTMR.IN=gIO.DIs.LeftHopperLow);
(LeftHopperLowTMR.PT=gHMI.Parameters.LowLeftHopperTime);
TON(&LeftHopperLowTMR);
if(LeftHopperLowTMR.Q){
(LeftHopperLowAlarm=1);
}
(RightHopperLowTMR.IN=gIO.DIs.RightHopperLow);
(RightHopperLowTMR.PT=gHMI.Parameters.LowRightHopperTime);
TON(&RightHopperLowTMR);
if(RightHopperLowTMR.Q){
(RightHopperLowAlarm=1);
}



(FeedStopTimer.IN=(gIO.DIs.BodyHopperLow|gIO.DIs.RightHopperLow|gIO.DIs.LeftHopperLow));
...
(BodyHopperLowAlarm=0);
}
if((gIO.DIs.LeftHopperLow^1)){
(LeftHopperLowAlarm=0);
}
if((gIO.DIs.RightHopperLow^1)){
(RightHopperLowAlarm=0);
}
...
if((MoveVelocityRequest&DownstreamBlocked)){
(gModeControlInterface.Status.WaitingOnDownstream=1);
(gHMI.Commands.RequestVFDRun=0);
}

if((gModeControlInterface.Status.WaitingOnDownstream&(gIO.DIs.DownstreamSensor^1))){
(gModeControlInterface.Status.WaitingOnDownstream=0);
(gHMI.Commands.RequestVFDRun=1);

}else if(gHMI.Commands.RequestStop){
(gModeControlInterface.Status.WaitingOnDownstream=0);
}
...
if((Rtrig_PhotoEyeSeen.Q&((gHMI.Commands.SelectAutoMode&gHMI.Commands.RequestVFDRun)|(((signed long)(signed long)(char)gCyclesToFinish>(signed long)(signed long)(char)0))))){
...
(BodyPanelTimeout.IN=(gHMI.Commands.RequestVFDRun&gIO.DIs.BodyDetect));
...
(InfeedTimeout.PT=gHMI.Parameters.TopFeedJamTime);
(InfeedTimeout.IN=(gHMI.Commands.RequestVFDRun&(gIO.DIs.BodyDetect^1)));
TON(&InfeedTimeout);
if(InfeedTimeout.Q){
(InfeedCheckError=1);
}else if(gHMI.Commands.RequestReset){
...
if((gHMI.Commands.RequestVFDRun&(gIO.DIs.LeftHopperMotor_OFF|gIO.DIs.RightHopperMotor_OFF|gIO.DIs.BodyHopperMotor_OFF))){
(HopperRunningError=1);
}else if(gHMI.Commands.RequestReset){
(HopperRunningError=0);
}
...
#line 324 "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_Reworked/Logical/ModeControl/ModeControl_ST/Cyclic1.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_Reworked/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/ModeContro/Cyclic1.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_Reworked/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/ModeContro/Cyclic1.st.c\\\" \\\"C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_Reworked/Logical/ModeControl/ModeControl_ST/Cyclic1.st\\\"\\n\"");
__asm__(".previous");
