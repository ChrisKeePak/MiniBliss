...
{	MB_IDLE = 0,
	MB_REQUEST_SET_TEMPS2 = 1,
	MB_REQUEST_SET_TEMPS = 2,
	MB_READ_SET_TEMPS2 = 3,
	MB_READ_SET_TEMPS = 4,
	MB_REQUEST_ACT_TEMPS2 = 5,
	MB_REQUEST_ACT_TEMPS = 6,
	MB_READ_ACT_TEMPS2 = 7,
	MB_READ_ACT_TEMPS = 8,
	MB_REQUEST_MELTER_STATUS = 9,
	MB_READ_MELTER_STATUS = 10,
	MB_REQUEST_ADH_USE = 11,
	MB_READ_ADH_USE = 12,
	MB_WRITE_REGISTERS = 13,
	MB_READ_REGISTERS = 14,
	MB_REQUEST_MACHINE_STATUS = 15,
	MB_WRITE_SET_TEMP2 = 16,
	MB_WRITE_SET_TEMP = 17,
	MB_VERIFY_SET_TEMP_WRITE2 = 18,
	MB_VERIFY_SET_TEMP_WRITE = 19,
	MB_REQUEST_ATS_ALARMS = 20,
	MB_READ_ATS_ALARMS = 21,
	MB_ERROR = 999,
...
_BUR_LOCAL NordsonRxPacket_typ DummyPacket2;
_BUR_LOCAL NordsonRxPacket_typ DummyPacket;
