...
#include "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/MappCall/StatusID_Decoderst.h"
#line 1 "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Logical/Libraries/MappCall/StatusID_Decoder.nodebug"
#line 1 "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Logical/Libraries/MappCall/StatusID_Decoder.st"
unsigned char StatusID_Decoder(MpAxisErrorEnum IN){unsigned char __AS__StatusID_Decoder=0;{

switch(IN){

case 0:{
(__AS__StatusID_Decoder=0);

}break;case -1064239103:{
(__AS__StatusID_Decoder=1);

}break;case -1064239102:{
(__AS__StatusID_Decoder=2);

}break;case -1064239101:{
(__AS__StatusID_Decoder=3);

}break;case -1064239100:{
(__AS__StatusID_Decoder=4);

}break;case -1064239099:{
(__AS__StatusID_Decoder=5);

}break;case -1064239098:{
(__AS__StatusID_Decoder=6);

}break;case -1064239097:{
(__AS__StatusID_Decoder=7);

}break;case -1064239096:{
(__AS__StatusID_Decoder=8);

}break;case -1064239095:{
(__AS__StatusID_Decoder=9);

}break;case -1064239094:{
(__AS__StatusID_Decoder=10);

}break;case -2137980917:{
(__AS__StatusID_Decoder=11);

}break;case -1064239092:{
(__AS__StatusID_Decoder=12);

}break;case -1064239091:{
(__AS__StatusID_Decoder=13);

}break;case -1064074752:{
(__AS__StatusID_Decoder=14);

}break;case -2137816575:{
(__AS__StatusID_Decoder=15);

}break;case -2137816574:{
(__AS__StatusID_Decoder=16);

}break;case -2137816573:{
(__AS__StatusID_Decoder=17);

}break;case -2137816572:{
(__AS__StatusID_Decoder=18);

}break;case -1064074747:{
(__AS__StatusID_Decoder=19);

}break;case -2137816570:{
(__AS__StatusID_Decoder=20);

}break;case -2137816569:{
(__AS__StatusID_Decoder=21);

}break;case -1064074744:{
(__AS__StatusID_Decoder=22);

}break;case -1064074732:{
(__AS__StatusID_Decoder=23);

}break;case -1064074731:{
(__AS__StatusID_Decoder=24);

}break;case -1064074730:{
(__AS__StatusID_Decoder=25);

}break;case -1064074729:{
(__AS__StatusID_Decoder=26);

}break;case -1064074728:{
(__AS__StatusID_Decoder=27);

}break;case -2137816551:{
(__AS__StatusID_Decoder=28);

}break;case -1064074726:{
(__AS__StatusID_Decoder=29);

}break;case -1064074725:{
(__AS__StatusID_Decoder=30);

}break;case -2137816548:{
(__AS__StatusID_Decoder=31);

}break;case -2137816547:{
(__AS__StatusID_Decoder=32);

}break;case -1064074722:{
(__AS__StatusID_Decoder=33);

}break;case -1064074721:{
(__AS__StatusID_Decoder=34);

}break;}

}imp1_case0_34:imp1_endcase0_0:;return __AS__StatusID_Decoder;}
#line 112 "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Logical/Libraries/MappCall/StatusID_Decoder.nodebug"

void __AS__ImplInitStatusID_Decoder_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/MappCall/StatusID_Decoder.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/MappCall/StatusID_Decoder.st.c\\\" \\\"C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Logical/Libraries/MappCall/StatusID_Decoder.st\\\"\\n\"");
