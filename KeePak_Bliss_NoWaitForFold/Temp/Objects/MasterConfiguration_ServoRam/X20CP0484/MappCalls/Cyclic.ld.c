...
#include "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/MappCalls/Cyclicld.h"
#line 1 "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Logical/ServoMotion/MappCalls/Cyclic.nodebug"
#line 1 "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Logical/ServoMotion/MappCalls/Cyclic.ld"
...
(ServoPnP.pMpLink=((unsigned long)(&mpServoPick)));




(ServoPnP.pAxis=((unsigned long)(&gServoPnP)));




(ServoPnP.pEndlessPosition=((unsigned long)(&ServoPnP_EPD)));




((*(unsigned long*)&(ServoPnP.AxisInterface))=((unsigned long)(&gServoPnPInterface)));




(ServoPnP.Override=ServoOverride);

(ServoPnP.ErrorReset=gSoftwareReset);
...
(BodyHopper.pMpLink=((unsigned long)(&mpBodyHopper)));




(BodyHopper.pAxis=((unsigned long)(&gBodyHopper)));




(BodyHopper.pEndlessPosition=((unsigned long)(&BodyHopper_EPD)));




((*(unsigned long*)&(BodyHopper.AxisInterface))=((unsigned long)(&gBodyHopperInterface)));




(BodyHopper.Override=ServoOverride);

(BodyHopper.ErrorReset=gSoftwareReset);

AxisBasic(&BodyHopper);

(LeftHopper.pMpLink=((unsigned long)(&mpLeftHopper)));




(LeftHopper.pAxis=((unsigned long)(&gLeftHopper)));




(LeftHopper.pEndlessPosition=((unsigned long)(&LeftHopper_EPD)));




((*(unsigned long*)&(LeftHopper.AxisInterface))=((unsigned long)(&gLeftHopperInterface)));




(LeftHopper.Override=ServoOverride);

(LeftHopper.ErrorReset=gSoftwareReset);

AxisBasic(&LeftHopper);

(RightHopper.pMpLink=((unsigned long)(&mpRightHopper)));




(RightHopper.pAxis=((unsigned long)(&gRightHopper)));




(RightHopper.pEndlessPosition=((unsigned long)(&RightHopper_EPD)));




((*(unsigned long*)&(RightHopper.AxisInterface))=((unsigned long)(&gRightHopperInterface)));




(RightHopper.Override=ServoOverride);

(RightHopper.ErrorReset=gSoftwareReset);

AxisBasic(&RightHopper);}
}
#line 1 "C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Logical/ServoMotion/MappCalls/Cyclic.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/MappCalls/Cyclic.ld.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Temp/Objects/MasterConfiguration_ServoRam/X20CP0484/MappCalls/Cyclic.ld.c\\\" \\\"C:/Users/Crims/OneDrive/Documents/GitHub/MiniBliss/KeePak_Bliss_NoWaitForFold/Logical/ServoMotion/MappCalls/Cyclic.ld\\\"\\n\"");
__asm__(".previous");
